  ...
  return (
    <section className="py-24 md:py-32 px-6 bg-[#0a0e1a] relative z-10 border-t border-white/5">
      <div className="max-w-4xl mx-auto text-center">
        <FadeIn>
          <span className="eyebrow mx-auto mb-6">Currently onboarding our founding 5 partners.</span>
          ...
          <p className="text-[18px] text-white/70 leading-relaxed mb-10 max-w-2xl mx-auto">
            Each partner gets hands-on setup, direct access to our team, and a 30-day free trial. Once the 5 spots are filled, new clients go on a waitlist.
          </p>
